...
namespace API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RomDbContext>(opt => opt.UseInMemoryDatabase("ReturnOrderManagementDb"));
            services.AddScoped<RomDbContext>();

            services.AddDbContext<AppIdentityDbContext>(opt => opt.UseInMemoryDatabase("Identity"));
